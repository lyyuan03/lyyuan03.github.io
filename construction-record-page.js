...
const RECORD_PAGES = {
  ...
  "2026-lineage-lamp-building-record": {
    ...
    notice: "本頁為護法續脈燈首限定內容，提供階段性建院近況與精選紀錄，請勿任意轉載或轉傳。"
  }
};
...
function installConstructionRecordPage(pageConfig) {
  ...
  style.textContent = `
    ...
    .construction-record-mode .construction-record-view .article-body figure{margin:34px 0}
    .construction-record-mode .construction-record-view .article-body figure img,.construction-record-mode .construction-record-view .article-body p>img{border:1px solid rgba(139,104,63,.25);box-shadow:0 12px 30px rgba(63,48,36,.08)}

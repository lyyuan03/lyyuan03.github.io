...
function installBuildingPatronArticleEnhancements() {
  ...
  function addFigure(body, { id, anchor, src, caption, alt, eager = false }) {
  ...
  function decorate() {
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/05-old-structure-hq.webp?v=20260902-fullres-native-1",
      alt: "停工期間尚未整理的舊結構空間",
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/02-site-vision-hq.webp?v=20260902-fullres-native-1",
      alt: "靈元院整體空間設計示意",
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/06-current-exterior-hq.webp?v=20260902-fullres-native-1",
      alt: "靈元院目前完成的外部建築結構",
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/03-building-dimensions-hq.webp?v=20260902-fullres-native-1",
      alt: "靈元院建築尺寸與外觀配置圖",
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/04-steel-interior-hq.webp?v=20260902-fullres-native-1",
      alt: "鐵構建築目前內部空間",
    ...
    addFigure(body, {
      ...
      src: "assets/construction/2026-building-patron/01-design-courtyard-hq.webp?v=20260902-fullres-native-1",
      alt: "靈元院庭園與建築設計示意",
    ...
    addFigure(body, {
      id: "site-trees",
      anchor: "庭園、樹木、廊道、光線",
      src: "assets/construction/2026-building-patron/07-site-trees-hq.webp?v=20260902-fullres-native-1",
      alt: "靈元院建築旁保留的樹木與草地",

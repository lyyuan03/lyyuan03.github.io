...
import { selfGuidedSpiritualCalibrationArticle } from "./article-self-guided-spiritual-calibration.js?v=20260907-draft-1";
...
const seriesById = {
  ...
  "self-guided-spiritual-calibration": "靈修辨證",
...
export const staticArticles = [
  ...
  selfGuidedSpiritualCalibrationArticle,

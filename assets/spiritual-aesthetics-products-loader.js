(() => {
  ...
  if (!document.querySelector('style[data-product-photos]')) {
    ...
    style.textContent = `
      ...
      @media(max-width:760px){.product-visual svg.product-photo-svg{width:96%!important;height:96%!important}.result-visual svg.product-photo-svg{height:220px!important;max-width:165px!important;max-height:220px!important}}

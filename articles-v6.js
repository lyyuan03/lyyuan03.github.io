// Sponsor article access deployment marker: 20260828-backend-slug-source-2
...
async function loadArticleCore() {
  const coreModuleUrls = [
    "./articles-core-20260810-v6.js?v=20260828-backend-slug-source-2",
    "./articles-core-20260810-v6.js?v=20260828-backend-slug-source-2&retry=1"
  ];
  let lastError = null;

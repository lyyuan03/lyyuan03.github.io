...
async function loadArticleCore() {
  try {
    await import("./articles-core-20260810-v6.js?v=20260813-firestore-content-priority-1");
  } catch (error) {
...
async function loadArticleAddons() {
  const addons = [
    ...
    ["贊助文章購買框", "./article-paid-gate-restore.js?v=20260812-paid-gate-selfcontained-7"]
  ];

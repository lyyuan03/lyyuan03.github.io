...
async function loadArticleCore() {
  const coreModuleUrls = [
    "./articles-core-20260810-v6.js?v=20260829-firestore-single-source-1",
    "./articles-core-20260810-v6.js?v=20260829-firestore-single-source-1&retry=1"
  ];
  let lastError = null;
...
async function loadArticleAddons() {
  const addons = [
    ...
    ["付費正文安全載入", "./paid-article-secure-loader.js?v=20260829-base64-clean-1"],

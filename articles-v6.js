...
async function loadArticleCore() {
  const coreModuleUrls = [
    "./articles-core-20260810-v6.js?v=20260829-reconciliation-draft-1",
    "./articles-core-20260810-v6.js?v=20260829-reconciliation-draft-1&retry=1"
  ];
  let lastError = null;
...
async function loadArticleAddons() {
  const addons = [
    ...
    ["非會員贊助方案", "./article-paid-gate-restore.js?v=20260829-reconciliation-draft-1"],
    ["付費正文安全載入", "./paid-article-secure-loader.js?v=20260829-reconciliation-draft-1"],

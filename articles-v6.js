// Sponsor article access deployment marker: 20260828-firestore-source-of-truth-1
...
async function loadArticleCore() {
  const coreModuleUrls = [
    "./articles-core-20260810-v6.js?v=20260828-firestore-source-of-truth-1",
    "./articles-core-20260810-v6.js?v=20260828-firestore-source-of-truth-1&retry=1"
  ];
  let lastError = null;
...
async function loadArticleAddons() {
  const addons = [
    ...
    ["付費正文安全載入", "./paid-article-secure-loader.js?v=20260828-firestore-source-of-truth-1"],

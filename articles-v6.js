// Sponsor article access deployment marker: 20260828-admin-draft-preview-2
...
async function loadArticleCore() {
  const coreModuleUrls = [
    "./articles-core-20260810-v6.js?v=20260828-admin-draft-preview-2",
    "./articles-core-20260810-v6.js?v=20260828-admin-draft-preview-2&retry=1"
  ];
  let lastError = null;
...
async function loadArticleAddons() {
  const addons = [
    ...
    ["非會員贊助方案", "./article-paid-gate-restore.js?v=20260828-admin-draft-preview-2"],
    ["付費正文安全載入", "./paid-article-secure-loader.js?v=20260828-admin-draft-preview-2"],

...
if (/(^|\/)articles\.html$/i.test(currentPath)) {
  ...
  window.setTimeout(() => import("./article-thumbnail-display.js?v=20260802-thumbnail-recovery-1"), 0);
}
...
if (/(^|\/)admin\.html$/i.test(currentPath)) {
  ...
  window.setTimeout(() => import("./article-thumbnail-admin.js?v=20260802-thumbnail-recovery-1"), 0);
}
